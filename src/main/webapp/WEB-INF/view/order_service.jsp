...
<div style="font-size: 16px; text-align: end;">
    ...
    <a class="btn" href="${pageContext.request.contextPath}/view/order/service?language=UA">UA</a>
    <a class="btn" href="${pageContext.request.contextPath}/view/order/service?language=EN">EN</a>
    </a>
</div>

<caption align="center"><h2><fmt:message key="chooseService"/></h2></caption>
<div>
    ...
    >
        ...
        <tr>
            ...
            <th data-sortable="true"><fmt:message key="description"/></th>
        ...
        <tbody>
        <c:forEach var="map" items="${serviceTimeSlotMap}">
        <tr>
            <th>${map.key.id}</th>
            <th>${map.key.name}</th>
            <th>${map.key.description}</th>
            <th>${map.key.price}</th>
            <th>${map.key.duration}</th>
            <th>
                <c:forEach var="mapValue" items="${map.value}">
                    <a
                        ...
                        <%--                class="scroll-animite btn"--%>
                            ...
                            href="${pageContext.request.contextPath}/view/order?time=${mapValue}&service=${map.key.name}">${mapValue}</a>
